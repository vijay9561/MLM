...
$query="select e.product_id,e.order_assign_seller_by,e.vendor_id,e.assign_vendor_id,e.employee_id,e.product_id,e.id,e.status,e.created_date,r.name as c_name,r.mobile as c_mobile,v.name as v_name,v.mobile as v_mobile,v.vendor_store_name,p.title,p.discount_price from product_enquiry e inner join registration r on r.rid=e.userid inner join registration v on v.rid=e.vendor_id inner join product_details p on e.product_id=p.pid  where (p.title LIKE '%".$searchid."%' OR v.name LIKE '%".$searchid."%' OR v.mobile LIKE '%".$searchid."%' OR r.name LIKE '%".$searchid."%' OR r.mobile LIKE '%".$searchid."%') and e.status='Inprogress' order by e.id desc LIMIT ".$pageLimit." , ".$setLimit;

$mysqluery=mysql_query($query);
}else{
$query="select e.product_id,e.order_assign_seller_by,e.vendor_id,e.assign_vendor_id,e.employee_id,e.product_id,e.id,e.status,e.created_date,r.name as c_name,r.mobile as c_mobile,v.name as v_name,v.mobile as v_mobile,v.vendor_store_name,p.title,p.discount_price from product_enquiry e inner join registration r on r.rid=e.userid inner join registration v on v.rid=e.vendor_id inner join product_details p on e.product_id=p.pid where e.status='Inprogress' order by e.id desc LIMIT ".$pageLimit." , ".$setLimit;
$mysqluery=mysql_query($query);
}
}elseif($_SESSION['ADMIN_TYPE']=='Employee'){
  if(isset($_GET['searchkeyowords'])){
$searchid=$_GET['searchkeyowords'];
$query="select e.product_id,e.order_assign_seller_by,e.vendor_id,e.assign_vendor_id,e.employee_id,e.product_id,e.id,e.status,e.created_date,r.name as c_name,r.mobile as c_mobile,v.name as v_name,v.mobile as v_mobile,v.vendor_store_name,p.title,p.discount_price from product_enquiry e inner join registration r on r.rid=e.userid inner join registration v on v.rid=e.vendor_id inner join product_details p on e.product_id=p.pid  where (p.title LIKE '%".$searchid."%' OR v.name LIKE '%".$searchid."%' OR v.mobile LIKE '%".$searchid."%' OR r.name LIKE '%".$searchid."%' OR r.mobile LIKE '%".$searchid."%') and e.status='Inprogress' and e.employee_id='$userid' order by e.id desc LIMIT ".$pageLimit." , ".$setLimit;

$mysqluery=mysql_query($query);
}else{
$query="select e.product_id,e.order_assign_seller_by,e.vendor_id,e.assign_vendor_id,e.employee_id,e.product_id,e.id,e.status,e.created_date,r.name as c_name,r.mobile as c_mobile,v.name as v_name,v.mobile as v_mobile,v.vendor_store_name,p.title,p.discount_price from product_enquiry e inner join registration r on r.rid=e.userid inner join registration v on v.rid=e.vendor_id inner join product_details p on e.product_id=p.pid where e.status='Inprogress' and e.employee_id='$userid' order by e.id desc LIMIT ".$pageLimit." , ".$setLimit;
$mysqluery=mysql_query($query);
}  
}elseif($_SESSION['ADMIN_TYPE']=='Vendors'){ 
 if(isset($_GET['searchkeyowords'])){
$searchid=$_GET['searchkeyowords'];
$query="select e.product_id,e.order_assign_seller_by,e.vendor_id,e.assign_vendor_id,e.employee_id,e.product_id,e.id,e.status,e.created_date,r.name as c_name,r.mobile as c_mobile,v.name as v_name,v.mobile as v_mobile,v.vendor_store_name,p.title,p.discount_price from product_enquiry e inner join registration r on r.rid=e.userid inner join registration v on v.rid=e.vendor_id inner join product_details p on e.product_id=p.pid  where (p.title LIKE '%".$searchid."%' OR v.name LIKE '%".$searchid."%' OR v.mobile LIKE '%".$searchid."%' OR r.name LIKE '%".$searchid."%' OR r.mobile LIKE '%".$searchid."%') and e.status='Inprogress' and e.assign_vendor_id='$userid' order by e.id desc LIMIT ".$pageLimit." , ".$setLimit;

$mysqluery=mysql_query($query);
}else{
$query="select e.product_id,e.order_assign_seller_by,e.vendor_id,e.assign_vendor_id,e.employee_id,e.product_id,e.id,e.status,e.created_date,r.name as c_name,r.mobile as c_mobile,v.name as v_name,v.mobile as v_mobile,v.vendor_store_name,p.title,p.discount_price from product_enquiry e inner join registration r on r.rid=e.userid inner join registration v on v.rid=e.vendor_id inner join product_details p on e.product_id=p.pid where e.status='Inprogress' and e.assign_vendor_id='$userid' order by e.id desc LIMIT ".$pageLimit." , ".$setLimit;
$mysqluery=mysql_query($query);
}         
}
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
        ...
        <img id="loading-image" src="images/show_loader.gif" alt="Loading..." />
			...
			<ol class="breadcrumb">
				...
				<li class="active">Inprogress Order Enquiry</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<!--<h1 class="page-header">Inprogress Order Enquiry</h1>-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">New Product Enquiry</div>
...
<input type="text" id="quntity" name="quntity" placeholder="Quantity" maxlength="10" onChange="quntityr()" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" outocomplete="off" class="form-control">
								...
								<div class="form-group  col-md-12">
									...
									<span id="vendor_idr" style="color:red;"></span>
                                                               ...
                                                               <?php }else{ ?>
                                                        <input type="hidden" name="vendor_id" id="vendor_id" value="<?php echo $_SESSION['ADMIN_ID']; ?>" onchange="vendor_idr()">
                                                        <span id="vendor_idr" style="color:red;"></span>
                                                               <?php } ?>								
...
<input type="text" id="quntity" name="quntity" placeholder="Quantity" maxlength="10" value="<?php echo $product['product_quantity']; ?>" onChange="quntityr()" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" outocomplete="off" class="form-control">
									...
									<span id="vendor_idr" style="color:red;"></span>
                                          ...
                                          <?php }else{ ?>
                                          <input type="hidden" value="<?php echo $_SESSION['ADMIN_ID']; ?>" id="vendor_id" name="vendor_id" onchange="vendor_idr();">
                                          <span id="vendor_idr" style="color:red;"></span>
                                          <?php } ?>
									<div class="form-group">
									<label>Product Additional Information (optional)</label>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<a href="product_enquiry_inprogress.php" class="btn btn-primary">Back</a>
		    ...
		    <table id="datatable" class="table table-striped table-bordered">
					  ...
					  $serial = ($pageLimit * $setLimit) + 1;
					   ...
					   ?>
                          <tr>
                            ...
                            <td>
                           <?php if($_SESSION['ADMIN_TYPE']=='Admin' || $_SESSION['ADMIN_TYPE']=='Employee'){ 
                               if(empty($row['assign_vendor_id'])) {
                               ?>  
                            <div class="dropdown"> 
                                
                            <button class="btn btn-primary btn-sm dropdown-toggle" type="button" data-toggle="dropdown">Inprogress
                            <span class="caret"></span></button>
                            <ul class="dropdown-menu">
                                <li><a href="post.php?action=cancel_enquiry_orders&cancel_orders=<?php echo base64_encode($row['id']); ?>" onclick="return confirm('are you sure to cancel this order enquiry')">Cancel Order Enquiry</a></li>
                                
                                <li><a href="post.php?action=send_enquiry_for_seller&send_orders=<?php echo base64_encode($row['id']); ?>&seller_name=<?php echo base64_encode($row['vendor_id']); ?>" onclick="return confirm('are you sure the send order to seller')">Send Enquiry For Seller</a></li>
         
                            </ul>
                              
                            </div>
                                <?php }else{ ?>
                                <b class="btn btn-warning btn-block btn-sm">Order Assign To Seller</b>
                                <a style="margin-top:5px;" href="product_enquiry_inprogress.php?opendata=<?php echo $row['id']; ?>" title="View Order" class="btn btn-primary btn-block btn-sm"><i class="fa fa-eye"></i> View Enquiry </a>
                                <?php } ?>
                           <?php }elseif($_SESSION['ADMIN_TYPE']=='Vendors'){ ?>
                                  <div class="dropdown"> 
                                 <a href="product_enquiry_inprogress.php?opendata=<?php echo $row['id']; ?>" title="View Order" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> </a>
                            <button class="btn btn-primary btn-sm dropdown-toggle" type="button" data-toggle="dropdown">Inprogress
                            <span class="caret"></span></button>
                            <ul class="dropdown-menu">
                               <!-- <li><a href="post.php?action=cancel_enquiry_orders&cancel_orders=<?php echo base64_encode($row['id']); ?>" onclick="return confirm('are sure to cancel this order enquiry')">Cancel Order Enquiry</a></li>-->
                                <li><a href="post.php?action=delivered_orders_for_customer&delivers=<?php echo base64_encode($row['id']); ?>&product_id=<?php echo base64_encode($row['product_id']); ?>" onclick="return confirm('are you sure delivered orders?')">Delivered Orders</a></li>
					...
					<?php
                                    ...
                                    if($_SESSION['ADMIN_TYPE']=='Admin'){
                                       if(isset($_GET['searchkeyowords'])){
                                           $searchid=$_GET['searchkeyowords'];
                                         $query="SELECT COUNT(*) as totalCount,e.product_id,e.id,e.status,e.created_date,r.name as c_name,r.mobile as c_mobile,v.name as v_name,v.mobile as v_mobile,v.vendor_store_name,p.title,p.discount_price from product_enquiry e inner join registration r on r.rid=e.userid inner join registration v on v.rid=e.vendor_id inner join product_details p on e.product_id=p.pid  where (p.title LIKE '%".$searchid."%' OR v.name LIKE '%".$searchid."%' OR v.mobile LIKE '%".$searchid."%' OR r.name LIKE '%".$searchid."%' OR r.mobile LIKE '%".$searchid."%') and e.status='Inprogress'";  
                                         echo standard_paging_function($setLimit,$page,$query,$searchid); } else{  
                                           $query="SELECT COUNT(*) as totalCount,e.product_id,e.id,e.status,e.created_date,r.name as c_name,r.mobile as c_mobile,v.name as v_name,v.mobile as v_mobile,v.vendor_store_name,p.title,p.discount_price from product_enquiry e inner join registration r on r.rid=e.userid inner join registration v on v.rid=e.vendor_id inner join product_details p on e.product_id=p.pid where e.employee_id='Inprogress' order by e.id desc";
                                         echo standard_paging_function($setLimit,$page,$query,$searchid);  }  
                                    }elseif($_SESSION['ADMIN_TYPE']=='Employee'){
                                      if(isset($_GET['searchkeyowords'])){
                                           $searchid=$_GET['searchkeyowords'];
                                         $query="SELECT COUNT(*) as totalCount,e.product_id,e.id,e.status,e.created_date,r.name as c_name,r.mobile as c_mobile,v.name as v_name,v.mobile as v_mobile,v.vendor_store_name,p.title,p.discount_price from product_enquiry e inner join registration r on r.rid=e.userid inner join registration v on v.rid=e.vendor_id inner join product_details p on e.product_id=p.pid  where (p.title LIKE '%".$searchid."%' OR v.name LIKE '%".$searchid."%' OR v.mobile LIKE '%".$searchid."%' OR r.name LIKE '%".$searchid."%' OR r.mobile LIKE '%".$searchid."%') and e.status='Inprogress' and e.employee_id='$userid'";  
                                         echo standard_paging_function($setLimit,$page,$query,$searchid); } else{  
                                           $query="SELECT COUNT(*) as totalCount,e.product_id,e.id,e.status,e.created_date,r.name as c_name,r.mobile as c_mobile,v.name as v_name,v.mobile as v_mobile,v.vendor_store_name,p.title,p.discount_price from product_enquiry e inner join registration r on r.rid=e.userid inner join registration v on v.rid=e.vendor_id inner join product_details p on e.product_id=p.pid where  e.status='Inprogress' and e.employee_id='$userid' order by e.id desc";
                                         echo standard_paging_function($setLimit,$page,$query,$searchid);  }    
                                       }elseif($_SESSION['ADMIN_TYPE']=='Vendors'){
                                        if(isset($_GET['searchkeyowords'])){
                                           $searchid=$_GET['searchkeyowords'];
                                         $query="SELECT COUNT(*) as totalCount,e.product_id,e.id,e.status,e.created_date,r.name as c_name,r.mobile as c_mobile,v.name as v_name,v.mobile as v_mobile,v.vendor_store_name,p.title,p.discount_price from product_enquiry e inner join registration r on r.rid=e.userid inner join registration v on v.rid=e.vendor_id inner join product_details p on e.product_id=p.pid  where (p.title LIKE '%".$searchid."%' OR v.name LIKE '%".$searchid."%' OR v.mobile LIKE '%".$searchid."%' OR r.name LIKE '%".$searchid."%' OR r.mobile LIKE '%".$searchid."%') and e.status='Inprogress' and e.assign_vendor_id='$userid'";  
                                         echo standard_paging_function($setLimit,$page,$query,$searchid); } else{  
                                           $query="SELECT COUNT(*) as totalCount,e.product_id,e.id,e.status,e.created_date,r.name as c_name,r.mobile as c_mobile,v.name as v_name,v.mobile as v_mobile,v.vendor_store_name,p.title,p.discount_price from product_enquiry e inner join registration r on r.rid=e.userid inner join registration v on v.rid=e.vendor_id inner join product_details p on e.product_id=p.pid where  e.status='Inprogress' and e.assign_vendor_id='$userid' order by e.id desc";
                                         echo standard_paging_function($setLimit,$page,$query,$searchid);  }  
                                    }
...
window.location='product_enquiry.php?searchkeyowords='+search_id2;
return false;
}
