...
--
-- Host: localhost
-- Generation Time: May 31, 2019 at 01:02 PM
...
CREATE TABLE `address_details` (
  ...
  `mobile_no` varchar(30) CHARACTER SET utf8 NOT NULL,
  `uid` int(11) NOT NULL,
...
(1, 'vijay jadhav', 'hello', 'maharshtra', 'nanded', '9158670769', 2, 431714),
(2, 'vijay', 'tesr', 'Maharashtra', 'pune', '9158680769', 1, 431714);
...
CREATE TABLE `admin` (
  ...
  `date` date NOT NULL,
  `user_type` enum('Admin','Employee','Vendors') NOT NULL,
  `vendor_store_name` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `admin` (`id`, `username`, `email`, `password`, `mobile_no`, `status`, `date`, `user_type`, `vendor_store_name`) VALUES
(1, 'admin', 'admin@gmail.com', 'admin', '', 'active', '2016-08-06', 'Admin', '');
...
INSERT INTO `category` (`cid`, `category_name`, `status`, `date`, `image`, `added_by`) VALUES
(1, 'BEVERAGES', 'active', '2017-07-05 05:19:36', 'Plastic Product_4736_5460.jpg', 0),
(2, 'FRUITS & VEGETABLES', 'active', '2017-07-05 05:19:46', 'Toys_609_1908.jpg', 0),
(3, 'DAIRY & FROZEN', 'active', '2017-07-05 05:20:20', 'Home & Texttile_5737_5359.jpg', 0),
(4, 'HOME & PERSONAL CARE', 'active', '2017-07-05 05:20:40', 'Ball_7274_276.jpg', 0),
(5, 'DAILY ESSENTIALS', 'active', '2017-07-05 05:20:56', 'Security_2911_9245.jpg', 0),
(6, 'GROCERY & STA', 'active', '2017-07-05 05:21:34', 'Packging & Paper_6037_8684.jpg', 0),
(7, 'PACKAGE FOOD', 'active', '2018-10-13 21:17:14', 'Printing & Graphics_7759_9143.jpg', 0),
(8, 'New Cat', 'active', '2019-02-15 07:59:46', 'Metal_3565_3445.jpg', 0),
(9, 'New Cat1', 'active', '2019-02-15 08:02:24', 'Jwelari_6968_7049.jpg', 0),
(10, 'New Cat', 'active', '2019-02-15 08:03:35', 'Industried Appliances_9736_5645.jpg', 0),
(11, 'PACK', 'active', '2019-02-15 08:18:16', 'House  Hold_7649_4393.jpg', 0);
...
(1, 7, 4, 18, '2017-07-26 10:30:04', '2017-09-30 08:22:09', '1'),
(2, 9, 3, 12, '2017-09-30 08:36:46', '2017-11-21 09:05:33', '1'),
(3, 10, 7, 34, '2018-02-16 11:07:02', '2018-10-06 06:55:47', '1'),
(4, 22, 2, 10, '2018-10-14 05:07:49', '2019-01-28 18:21:44', '1'),
(5, 18, 1, 5, '2018-10-17 06:51:25', '2018-10-17 06:51:25', '1'),
(6, 23, 2, 10, '2018-10-17 06:51:56', '2019-02-03 12:25:59', '1'),
(7, 20, 2, 10, '2019-01-31 15:44:07', '2019-02-03 12:26:07', '1'),
(8, 24, 1, 5, '2019-02-01 13:56:38', '2019-02-01 13:56:38', '1'),
(9, 19, 1, 5, '2019-02-03 07:00:02', '2019-02-03 07:00:02', '1'),
(10, 27, 1, 5, '2019-02-17 09:39:34', '2019-02-17 09:39:34', '1');
...
INSERT INTO `notification_master` (`nid`, `notification_message`, `oid`, `uid`, `status`, `notification_date`, `vendor_id`, `emp_id`, `admin_id`) VALUES
(18, 'New orders enquiry', 8, 2, 'inactive', '2019-02-08 23:05:39', 0, 0, ''),
(19, 'New orders enquiry', 1, 2, 'inactive', '2019-02-08 23:22:48', 0, 0, ''),
(20, 'This customer enquiry assign for you', 1, 2, 'inactive', '2019-02-08 23:48:03', 0, 14, ''),
(21, 'New orders enquiry', 2, 2, 'inactive', '2019-02-09 18:07:06', 0, 0, 'Admin'),
(22, 'This customer enquiry assign for you', 2, 2, 'inactive', '2019-02-09 20:02:39', 0, 14, ''),
(23, 'New Enquiry Orders', 2, 2, 'inactive', '2019-02-09 21:19:09', 4, 0, ''),
(24, 'New orders enquiry', 3, 2, 'inactive', '2019-02-24 22:22:06', 0, 0, 'Admin'),
(25, 'New orders enquiry', 4, 2, 'inactive', '2019-03-10 15:35:19', 0, 0, 'Admin'),
(26, 'This customer enquiry assign for you', 4, 2, 'inactive', '2019-03-10 15:37:10', 0, 14, ''),
(27, 'New Enquiry Orders', 4, 2, 'inactive', '2019-03-10 15:41:33', 4, 0, ''),
(28, 'New orders enquiry', 5, 2, 'inactive', '2019-04-09 10:37:09', 0, 0, 'Admin'),
(29, 'This customer enquiry assign for you', 5, 2, 'active', '2019-04-09 10:39:56', 0, 14, '');
...
(1, 2, 'Bought it from somewhere else', 'afaf asfasdf', 2, 'active', '2017-10-13 14:21:23');
...
(1, 2, 'ID-168596', '2017-09-30 12:14:30', 'confirm', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2017-09-30 12:16:24', '0000-00-00 00:00:00'),
(2, 2, 'ID-794935', '2017-10-13 14:03:18', 'cancel', '2017-10-13 14:21:23', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(3, 2, 'ID-639633', '2017-11-13 13:41:21', 'confirm', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2018-09-28 14:42:10', '0000-00-00 00:00:00'),
(4, 2, 'ID-192597', '2018-03-14 18:33:41', 'recived', '0000-00-00 00:00:00', '2018-09-28 14:42:18', '2018-03-14 18:34:03', '2018-03-14 18:34:27'),
(5, 2, 'ID-398159', '2018-10-05 11:57:56', 'confirm', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '2018-10-25 14:49:43', '0000-00-00 00:00:00'),
(6, 1, 'ID-443143', '2018-10-19 16:13:34', 'send', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(7, 1, 'ID-598646', '2018-10-25 14:49:15', 'send', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
(48, 1, 2, 1, 7, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(49, 1, 2, 1, 9, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(50, 1, 2, 1, 8, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(51, 2, 2, 3, 9, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(52, 3, 2, 1, 8, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(53, 3, 2, 1, 9, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(54, 4, 2, 3, 11, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(55, 5, 2, 1, 11, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(56, 5, 2, 1, 10, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(57, 5, 2, 1, 9, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(58, 5, 2, 1, 8, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(59, 6, 1, 1, 21, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(60, 7, 1, 1, 22, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
CREATE TABLE `pincode_master` (
  ...
  `pincode` int(11) NOT NULL,
  `area_city` varchar(500) CHARACTER SET utf8 NOT NULL,
  `status` enum('active','inactive') NOT NULL,
  `area_state` varchar(200) CHARACTER SET utf8 NOT NULL,
  `area_country` varchar(200) CHARACTER SET utf8 NOT NULL,
  `area` varchar(200) CHARACTER SET utf8 NOT NULL,
  `date` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 431714, 'Nanded', 'active', 'Maharashtra', 'India', 'Kandhar', '2017-09-30 12:14:01'),
(2, 411033, 'Pune', 'active', 'Maharashtra', 'India', 'Pune', '2018-10-25 14:46:37');
...
CREATE TABLE `product_details` (
  ...
  `product_additional_description` text CHARACTER SET utf8 NOT NULL,
  `vendor_id` bigint(20) NOT NULL,
  `added_by` varchar(200) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `product_details` (`pid`, `title`, `price`, `discount_price`, `description`, `category_id`, `sub_category_id`, `sub_sub_category_id`, `date`, `status`, `product_quantity`, `product_additional_description`, `vendor_id`, `added_by`, `userid`) VALUES
(12, 'Tropicana 100% Apple Juice : 1 Litre', 140, 99, '<p>\r\n	<span font-size:=\"\" helvetica=\"\" open=\"\" style=\"color: rgb(85, 89, 92); font-family: \">Tropicana selects best fruits to manufacture high-quality juices and original products. It is committed to fostering healthy lifestyles by ensuring that its products are naturally nutritious and provide the daily benefits that one needs.</span></p>\r\n', 1, 7, 0, '2018-10-13 22:01:33', 'active', 999, '', 7, 'vijay jadhav', 0),
(13, 'Frooti Mango Drink : 10x160 ml ', 100, 85, '<h1 class=\"product-details--title\" data-productid=\"268554\" font-weight:=\"\" helvetica=\"\" line-height:=\"\" open=\"\" style=\"box-sizing: inherit; font-size: 1.77689rem; margin: 0.8335rem 0px 17px; color: rgb(55, 58, 60); font-family: \">\r\n	<span class=\"product--title-text\" style=\"box-sizing: inherit;\">Frooti Mango Drink : 10x160 ml</span></h1>\r\n', 1, 7, 0, '2018-10-13 22:03:00', 'active', 1000, '', 5, 'vijay jadhav', 0),
(14, 'Maaza Mango Drink : 1.2 Litres', 70, 50, '<p>\r\n	<br font-size:=\"\" helvetica=\"\" open=\"\" style=\"box-sizing: inherit; color: rgb(85, 89, 92); font-family: \" />\r\n	<span font-size:=\"\" helvetica=\"\" open=\"\" style=\"color: rgb(85, 89, 92); font-family: \">Universally loved for its taste, colour, thickness and wholesome properties, Maaza is the mango lover&#39;s first choice.</span></p>\r\n', 1, 7, 0, '2018-10-13 22:04:11', 'active', 1000, '', 7, 'vijay jadhav', 0),
(15, 'Tur Dal Latur : 1 kg', 89, 80, '<h1 class=\"product-details--title\" data-productid=\"137026\" font-weight:=\"\" helvetica=\"\" line-height:=\"\" open=\"\" style=\"box-sizing: inherit; font-size: 1.77689rem; margin: 0.8335rem 0px 17px; color: rgb(55, 58, 60); font-family: \">\r\n	<span class=\"product--title-text\" style=\"box-sizing: inherit;\">Tur Dal Latur : 1 kg</span></h1>\r\n', 6, 15, 0, '2018-10-13 22:05:56', 'active', 1000, '', 5, 'vijay jadhav', 0),
(16, 'Chana Dal : 1 kg', 86, 78, '<h5 class=\"product-details--title\" data-productid=\"137021\" font-weight:=\"\" helvetica=\"\" line-height:=\"\" open=\"\" style=\"box-sizing: inherit; font-size: 1.77689rem; margin: 0.8335rem 0px 17px; color: rgb(55, 58, 60); font-family: \">\r\n	<span class=\"product--title-text\" style=\"box-sizing: inherit;\">Chana Dal : 1 kg&nbsp;</span></h5>\r\n', 6, 15, 0, '2018-10-13 22:07:35', 'active', 1000, '', 5, 'vijay jadhav', 0),
(17, 'Udid (Urad) Dal : 500 gms', 58, 50, '<h1 class=\"product-details--title\" data-productid=\"137027\" font-weight:=\"\" helvetica=\"\" line-height:=\"\" open=\"\" style=\"box-sizing: inherit; font-size: 1.77689rem; margin: 0.8335rem 0px 17px; color: rgb(55, 58, 60); font-family: \">\r\n	<span class=\"product--title-text\" style=\"box-sizing: inherit;\">Udid (Urad) Dal : 500 gms</span></h1>\r\n', 6, 15, 0, '2018-10-13 22:08:40', 'active', 1000, '', 5, 'vijay jadhav', 0),
(18, 'Fresh Onion : 1 kg', 35, 23, '<h1 class=\"product-details--title\" data-productid=\"174501\" font-weight:=\"\" helvetica=\"\" line-height:=\"\" open=\"\" style=\"box-sizing: inherit; font-size: 1.77689rem; margin: 0.8335rem 0px 17px; color: rgb(55, 58, 60); font-family: \">\r\n	<span class=\"product--title-text\" style=\"box-sizing: inherit;\">Fresh Onion : 1 kg</span></h1>\r\n', 2, 14, 2, '2018-10-13 22:10:18', 'active', 1000, '', 5, 'vijay jadhav', 0),
(19, 'Fresh Lemon / Nimboo : 5 Pieces', 40, 25, '<h1 class=\"product-details--title\" data-productid=\"237551\" font-weight:=\"\" helvetica=\"\" line-height:=\"\" open=\"\" style=\"box-sizing: inherit; font-size: 1.77689rem; margin: 0.8335rem 0px 17px; color: rgb(55, 58, 60); font-family: \">\r\n	<span class=\"product--title-text\" style=\"box-sizing: inherit;\">Fresh Lemon / Nimboo : 5 Pieces</span></h1>\r\n', 2, 14, 0, '2018-10-13 22:11:43', 'active', 1000, '', 7, 'vijay jadhav', 0),
(20, 'Fresh Potato : 1 kg', 45, 23, '<h1 class=\"product-details--title\" data-productid=\"174502\" font-weight:=\"\" helvetica=\"\" line-height:=\"\" open=\"\" style=\"box-sizing: inherit; font-size: 1.77689rem; margin: 0.8335rem 0px 17px; color: rgb(55, 58, 60); font-family: \">\r\n	<span class=\"product--title-text\" style=\"box-sizing: inherit;\">Fresh Potato : 1 kg</span></h1>\r\n', 2, 14, 0, '2018-10-13 22:13:04', 'active', 100, '', 7, 'vijay jadhav', 0),
(21, 'Society Tea : 1 kg', 425, 345, '<h1 class=\"product-details--title\" data-productid=\"174501\" font-weight:=\"\" helvetica=\"\" line-height:=\"\" open=\"\" style=\"box-sizing: inherit; font-size: 1.77689rem; margin: 0.8335rem 0px 17px; color: rgb(55, 58, 60); font-family: \">\r\n	<span class=\"product--title-text\" style=\"box-sizing: inherit;\">Fresh Onion : 1 kg</span></h1>\r\n', 1, 9, 10, '2018-10-13 22:16:18', 'active', 999, '', 5, 'vijay jadhav', 0),
(22, 'Brooke Bond Red Label Tea : 1 kg ', 410, 310, '<h1 class=\"product-details--title\" data-productid=\"14314\" font-weight:=\"\" helvetica=\"\" line-height:=\"\" open=\"\" style=\"box-sizing: inherit; font-size: 1.77689rem; margin: 0.8335rem 0px 17px; color: rgb(55, 58, 60); font-family: \">\r\n	<span class=\"product--title-text\" style=\"box-sizing: inherit;\">Brooke Bond Red Label Tea : 1 kg&nbsp;</span></h1>\r\n', 1, 9, 10, '2018-10-13 22:18:34', 'active', 999, '', 7, 'vijay jadhav', 0),
(23, 'Brooke Bond Red Label Tea : 1 kg ', 286, 200, '<p>\r\n	Vijay Jadhav</p>\r\n', 1, 8, 0, '2018-10-13 22:19:37', 'active', 2000, '', 5, 'Retrieving Recorded Logs', 0),
(24, 'Testing Product', 2000, 1800, '<p>\r\n	<span style=\"color: rgb(0, 0, 0); font-family: Dosis, sans-serif; font-size: 16px; letter-spacing: 1px;\">We are provide quality website development to my customers in India , understanding the fact that every business is different and so solutions and requirement would also differ.&nbsp;</span></p>\r\n', 7, 13, 5, '2019-01-30 12:47:26', 'active', 1995, '<p>\r\n	&nbsp;<span style=\"color: rgb(0, 0, 0); font-family: Dosis, sans-serif; font-size: 16px; letter-spacing: 1px;\">We are provide quality website development to my customers in India , understanding the fact that every business is different and so solutions and requirement would also differ.&nbsp;</span></p>\r\n', 4, 'vijay jadhav', 1),
(25, 'demo testing', 2000, 1800, '<p>\r\n	Testing Product</p>\r\n', 9, 0, 0, '2019-02-16 18:25:52', 'active', 2000, '<p>\r\n	Testing Product</p>\r\n', 4, 'vijay jadhav', 1),
(26, 'demo testing', 200, 3000, '<p>\r\n	Testing Products</p>\r\n', 8, 0, 0, '2019-02-16 18:37:24', 'active', 2000, '', 4, 'Sandip Surwase', 4),
(27, 'Product My Details', 2000, 1800, '<p>\r\n	Testing Images</p>\r\n', 5, 0, 0, '2019-02-16 18:40:32', 'active', 2998, '<p>\r\n	Testing Images</p>\r\n', 4, 'Sandip Surwase', 4),
(28, 'demo testing1', 2000, 1800, '<p>\r\n	Testing Products Details Images</p>\r\n', 8, 0, 0, '2019-02-16 18:41:34', 'active', 2000, '<p>\r\n	New Product Details</p>\r\n', 4, 'Sandip Surwase', 4);
...
CREATE TABLE `product_enquiry` (
  ...
  `status` enum('New Enquiry','Inprogress','Completed','Cancel') NOT NULL,
  `assign_vendor_id` bigint(11) NOT NULL,
  `delivery_date` datetime NOT NULL,
  `cancel_date` datetime NOT NULL,
  `cancel_type` varchar(200) CHARACTER SET utf8 NOT NULL,
  `cancel_note` text CHARACTER SET utf8 NOT NULL,
  `order_assign_seller_by` varchar(200) CHARACTER SET utf8 NOT NULL,
  `customer_needs` text NOT NULL,
  `enquiry_id` varchar(100) CHARACTER SET utf8 NOT NULL,
  `quantity` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `product_enquiry` (`id`, `userid`, `vendor_id`, `product_id`, `employee_id`, `created_date`, `status`, `assign_vendor_id`, `delivery_date`, `cancel_date`, `cancel_type`, `cancel_note`, `order_assign_seller_by`, `customer_needs`, `enquiry_id`, `quantity`) VALUES
(1, 2, 7, 19, 14, '2019-02-08 23:22:48', 'Inprogress', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '', 'Expectations', 'BUYMTI185265', 1),
(2, 2, 4, 24, 14, '2019-02-09 18:07:06', 'Completed', 4, '2019-02-16 18:33:40', '0000-00-00 00:00:00', '', '', 'VJMSOFTECH', 'Send Enquiry', 'BUYMTI632958', 5),
(3, 2, 4, 28, 0, '2019-02-24 22:22:06', 'Cancel', 0, '0000-00-00 00:00:00', '2019-02-24 22:23:56', 'Expected delivery time is too long', 'dsfsa', '', 'I want need', 'BUYMTI630898', 1),
(4, 2, 4, 27, 14, '2019-03-10 15:35:19', 'Completed', 4, '2019-03-10 15:44:47', '0000-00-00 00:00:00', '', '', 'VJMSOFTECH', '', 'BUYMTI509994', 2),
(5, 2, 4, 27, 14, '2019-04-09 10:37:09', 'Inprogress', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', '', '', '', 'BUYMTI871893', 1);
...
(44, 12, 'tropicana_juice.jpg'),
(45, 13, 'frooti_juice1.jpg'),
(46, 14, 'maza-juice.jpg'),
(47, 15, 'udit_dal.jpg'),
(48, 16, 'chana_dal.jpg'),
(49, 17, 'udit_dal.jpg'),
(50, 18, 'gajar.jpg'),
...
(53, 21, 'taj_mahal.jpg'),
(54, 22, 'red_label.jpg'),
(55, 23, 'IMG-20190129-WA0003.jpg'),
(56, 0, 'IMG-20190129-WA0001.jpg'),
(57, 0, 'IMG-20190129-WA0001 (1).jpg'),
(58, 0, 'IMG-20190129-WA0003.jpg'),
(59, 24, 'IMG-20190129-WA0001.jpg'),
(60, 24, 'IMG-20190129-WA0001 (1).jpg'),
(61, 24, 'IMG-20190129-WA0003.jpg'),
(62, 25, 'footerimg.png'),
(63, 25, 'WhatsApp Image 2019-02-14 at 5.56.31 PM.jpeg'),
(64, 25, 'buymart.jpg'),
(65, 27, 'footerimg.png'),
(66, 27, 'buymarttrade.jpeg'),
(67, 28, 't3.jpeg'),
(68, 28, 't1.jpeg'),
(69, 28, 'slide3.jpeg'),
(70, 28, 'slide1.jpeg'),
(71, 28, 'WhatsApp Image 2019-02-14 at 5.56.31 PM.jpeg');
...
(1, 2, 9, 'Good qulity Products', 'active', '2017-09-30 12:07:22'),
(2, 2, 10, 'Good', 'active', '2018-09-28 14:44:05'),
(3, 2, 17, 'Product Quality is very good', 'active', '2019-01-31 21:01:49');
...
INSERT INTO `quantity_master` (`id`, `qty`) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4),
...
CREATE TABLE `referral_users` (
  `id` bigint(20) NOT NULL,
  `refferral_id` bigint(20) NOT NULL,
  `userid` bigint(20) NOT NULL,
  `referral_point` int(20) NOT NULL,
...
INSERT INTO `referral_users` (`id`, `refferral_id`, `userid`, `referral_point`, `created_date`) VALUES
(1, 915868, 2, 20, '2018-10-05');
...
CREATE TABLE `registration` (
  ...
  `mobile` varchar(40) CHARACTER SET utf8 NOT NULL,
  `password` varchar(50) CHARACTER SET utf8 NOT NULL,
  `referral_id` varchar(233) CHARACTER SET utf8 NOT NULL,
  `status` enum('active','inactive') NOT NULL,
  `date` datetime NOT NULL,
  `profile_picture` varchar(500) CHARACTER SET utf8 NOT NULL,
  `vendor_store_name` varchar(200) CHARACTER SET utf8 NOT NULL,
  `user_type` enum('Users','Vendors','Employee','Admin') NOT NULL,
  `city_name` varchar(200) CHARACTER SET utf8 NOT NULL,
  `state_name` varchar(200) CHARACTER SET utf8 NOT NULL,
  `cst_no` varchar(200) CHARACTER SET utf8 NOT NULL,
  `shop_licence_no` varchar(200) NOT NULL,
...
INSERT INTO `registration` (`rid`, `name`, `email`, `mobile`, `password`, `referral_id`, `status`, `date`, `profile_picture`, `vendor_store_name`, `user_type`, `city_name`, `state_name`, `cst_no`, `shop_licence_no`, `Address`) VALUES
(1, 'vijay jadhav', 'admin@gmail.com', '9158680761', '123456', '915868', 'active', '2018-10-10 00:00:00', 'mypassport_1783.jpg', '', 'Admin', '', '', '', '', ''),
(2, 'vijay', 'vijay171819@gmail.com', '9158680762', '123456', '899764', 'active', '2018-10-05 23:21:58', 'IMG-20190129-WA0001 (1)_6716.jpg', '', 'Users', 'Itanagar', 'Arunachal Pradesh', '', '', ''),
(3, 'Retrieving Recorded Logs', 'vijay1237@gmail.com', '9158680751', '123456', '', 'active', '2019-01-29 16:24:03', '', 'Jewellery Added', 'Users', '', '', '', '', ''),
(4, 'Sandip Surwase', 'vjmsoftech@gmail.com', '9145346431', '123456', '', 'active', '2019-01-29 20:04:04', '', 'Jewellery Added', 'Vendors', 'Margherita', 'Assam', '343553453', '345435345435', 'Keshav Nagar '),
(5, 'Retrieving Recorded Logs', 'vijay.jadhav@btcmonk.com', '9158680764', '123456', '', 'active', '2019-01-29 22:45:39', '', 'Jewellery Added', 'Employee', 'Silao', 'Bihar', '', '', ''),
(7, 'Adams Armaturen GmbH & Co', 'vikram@gmail.com', '9158680768', '123456', '', 'active', '2019-01-30 10:19:21', '', 'Modern Jewellery Pune', 'Vendors', 'Bomdila', 'Arunachal Pradesh', '', '', ''),
(12, 'Manisha Jadhav', 'manisha12@gmail.com', '9168992289', '123456', '', 'active', '2019-02-01 17:43:53', '', '', 'Users', '', '', '', '', ''),
(13, 'Vilas Pandurang', 'vijay1234@gmail.com', '91586807612', '123456', '', 'active', '2019-02-01 18:08:15', '', '', 'Users', '', '', '', '', ''),
(14, 'VJMSOFTECH', 'vijaddd@gmail.com', '9123454534', '123456', '', 'active', '2019-02-02 23:54:16', '', '', 'Employee', '', '', '', '', ''),
(15, 'xyz emplye', 'sadafd@gmail.com', '8123454312', '123456', '', 'active', '2019-02-02 23:58:16', '', '', 'Employee', '', '', '', '', ''),
(16, 'Ankush', 'ankushjadhav7591@gmail.com', '9623941819', '123456', '', 'inactive', '2019-02-03 13:04:59', '', '', 'Users', '', '', '', '', ''),
(17, 'vijay jadhav', 'aasfaf@gmail.com', '9158680769', '123456', '', 'inactive', '2019-03-16 16:35:12', '', 'Modern Jewellery Pune', 'Vendors', 'Mumbai', 'Maharashtra', '', '', '');
...
INSERT INTO `sub_category` (`scid`, `mid`, `category_name`, `date`, `status`, `added_by`) VALUES
(1, 4, 'Hair Care', '2017-07-05 05:25:24', 'active', 0),
(2, 4, 'Skin Care', '2017-07-05 05:26:33', 'active', 0),
(3, 3, 'Curd & Shrikhand', '2017-07-05 05:26:47', 'active', 0),
(4, 3, 'Cheese', '2017-07-05 05:27:14', 'active', 0),
(5, 3, 'Butter', '2017-07-05 05:27:26', 'active', 0),
(7, 1, 'Juices', '2017-07-05 05:28:00', 'active', 0),
(8, 1, 'Health Drinks', '2017-07-05 05:28:18', 'active', 0),
(9, 1, 'Tea & Coffee', '2017-07-05 05:29:05', 'active', 0),
(10, 7, 'Breakfast Cereals', '2017-07-05 05:29:41', 'active', 0),
(11, 7, 'Snacks & Farsans', '2017-07-05 05:30:10', 'active', 0),
(13, 7, 'Biscuits & Cookies', '2017-07-05 05:30:46', 'active', 0),
(14, 2, 'Fresh Vegetables', '2017-07-05 05:31:04', 'active', 0),
(15, 6, 'Dals', '2017-07-05 05:37:12', 'active', 0),
(16, 6, 'Ghee & Vanaspati', '2017-07-05 05:42:21', 'active', 0),
(17, 6, 'Cooking Oil', '2017-07-06 05:52:44', 'active', 0);
...
INSERT INTO `sub_sub_category` (`sscid`, `scid`, `cid`, `category_name`, `status`, `date`, `added_by`) VALUES
(1, 16, 6, 'Ghee', 'active', '2017-07-06 05:53:49', 0),
(2, 17, 6, 'Blended Oil', 'active', '2017-07-06 05:54:03', 0),
(3, 17, 6, 'Sunflower Oil', 'active', '2017-07-06 05:54:24', 0),
(4, 16, 6, 'Vanaspati', 'active', '2018-10-13 21:35:03', 0),
(5, 13, 7, 'Cookies', 'active', '2018-10-13 21:35:48', 0),
(6, 11, 7, 'Popcorn', 'active', '2018-10-13 21:37:20', 0),
(7, 10, 7, 'Flakes', 'active', '2018-10-13 21:38:12', 0),
(8, 2, 4, 'Lip Care', 'active', '2018-10-13 21:39:29', 0),
(9, 1, 4, 'Hair Gel & Cream', 'active', '2018-10-13 21:40:06', 0),
(10, 9, 1, 'Tea', 'active', '2018-10-13 21:44:30', 0);

-- --------------------------------------------------------

--
-- Table structure for table `vendors_otp`
--

CREATE TABLE `vendors_otp` (
  `id` int(11) NOT NULL,
  `mobile` varchar(20) NOT NULL,
  `otp` int(11) NOT NULL,
  `verify_no` int(11) NOT NULL,
...
--
-- Dumping data for table `vendors_otp`
--

INSERT INTO `vendors_otp` (`id`, `mobile`, `otp`, `verify_no`, `userid`, `datetime`, `send_count`) VALUES
(1, '9158680769', 369147, 1, 13, '2019-03-16 11:08:13', 1),
(2, '9623941819', 242666, 1, 16, '2019-02-03 07:37:10', 2),
(3, '9158680769', 160409, 0, 17, '2019-03-16 11:05:12', 1);
...
--
-- Indexes for table `vendors_otp`
--
ALTER TABLE `vendors_otp`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `order_items_details`
  MODIFY `oidid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;

--
-- AUTO_INCREMENT for table `order_return_items`
--
ALTER TABLE `order_return_items`
  MODIFY `oidid` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `product_images`
  MODIFY `piid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
...
--
ALTER TABLE `sub_sub_category`
  MODIFY `sscid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `vendors_otp`
--
ALTER TABLE `vendors_otp`
