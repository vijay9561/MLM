...
<meta name="keywords" content="Buy Mart Trade India" />
...
<div class="container">
		<div class="head">
			<div class=" logo">
                            <a href="index.php"><img class="indiamartlogos" src="images/footerimg.png" alt=""></a>	
			</div>
		</div>
	</div>
	<div class="header-top">
		...
		<!--<div class="col-sm-5 col-md-offset-2 header-social">
                ...
                <div class="col-sm-5  header-login" style="text-align: right;">		
					
					<ul>
					<?php if(!isset($_SESSION['ID'])){ ?>
						<li><a href="login.php">Login</a></li>
						<li><a href="register.php">Buyer Register</a></li>
                                                <li><a href="vendor_register.php">Seller Register</a></li>
						...
						<ul class="dropdown-menu" role="menu" aria-labelledby="menu1" id="menu1" style="left: auto;">
						<li role="presentation"><a role="menuitem" tabindex="-1" href="my-profile.php"><i class="fa fa-user"></i> My Profile</a></li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="product_enquiry.php"><i class="fa fa-shopping-cart"></i> My Order Enquiry</a></li>
		...
		<div class="container" style="margin-top: 7px;">
		 ...
		 <div class="col-sm-3 col-md-offset-2 h_menu4">
 ...
 <!-- Brand and toggle get grouped for better mobile display -->
  <div class="navbar-header nav_2">
   ...
   <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse get_details_menu" id="bs-megadropdown-tabs">
        <ul class="nav navbar-nav nav_1">
            <li><a href="index.php"> HOME</a></li>
           <li style="display:none;" class="bussines_mart1"><a href="http://business.buymarttradeindia.com/">BUYMART BUSINESS</a></li> 
		...
		<?php  $maincategory=mysql_query("select category_name,cid from category order by cid asc limit 0,3");  while($cat=mysql_fetch_array($maincategory)) { ?>
    		<!--<li  class="dropdown mega-dropdown active">
			    <a  class="color1" href="product.php?maincategory=<?php echo $cat['cid']; ?>" class="dropdown-toggle" data-toggle="dropdown" style=" text-transform: uppercase;"><?php echo ($cat['category_name']); ?><span class="caret"></span></a>				
				<div class="dropdown-menu ">
					...
					<?php $subcategories=mysql_query("select  category_name,mid,scid from sub_category where mid='".$cat['cid']."'"); while($subcat=mysql_fetch_array($subcategories)) { ?>
						<div class="col1">
							<div class="h_nav">
								<h4 style="font-size:16px;"><a href="product.php?subcategory=<?php echo $subcat['scid']; ?>" style="color:#424242;"><?php echo $subcat['category_name']; ?></a></h4>
									<ul>
								...
								while($susubbcat=mysql_fetch_array($subsubcategories)) { ?>
										<li><a href="product.php?subsubcategory=<?php echo $susubbcat['sscid']; ?>" style="color: #757575;font-weight: normal;"><?php echo $susubbcat['category_name']; ?></a></li>
										<?php } ?>
...
.countcart {
    ...
    font-size: 15px;
                            ...
                            <div class="col-sm-6 col-xs-12 search_divs">
                ...
                <div class="input-group-btn search-panel">
                    ...
                    <ul class="dropdown-menu" role="menu">
                     <?php
                      $maincategory=mysql_query("select category_name,cid,image from category order by cid asc");
                     while($main=mysql_fetch_array($maincategory)){ ?>
                        <li style="border-bottom: 1px solid #c0bcbc;">
                          
                          <a href="product.php?maincategory=<?php echo $main['cid']; ?>">
                         
                              <?php echo $main['category_name']; ?></a></li>
                     <?php } ?>
                    </ul>
                </div>
                <input type="hidden" name="search_param" value="all" id="search_param">  
                <input type="text" class="form-control"  onkeydown="if(event.keyCode == 13) return product_details()"  placeholder="Search Item" id="jobpostsearch" name="jobpostsearch"  onChange="jobpostsearchr();">
                 
	        <input type="hidden" name="hiddensearchjob" id="hiddensearchjob">
                <span class="input-group-btn">
                    <button class="btn btn-default" type="button" onClick="return product_details()"><span class="glyphicon glyphicon-search"></span></button>
                </span>
