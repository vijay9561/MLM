...
<div class="banner-top">
	<div class="container" style="text-align: center;margin-top: 102px;">
		...
		<h2><a href="index.php">Home</a><label>/</label>Products Categories</a></h2>
	</div>
</div>
	<!--content-->
		<div class="product">
			...
			<div class="col-md-12" style="    border-right: 3px solid #EFEFEF;">
                            <div class="row search_divss">
                             <?php  $category=mysql_query("select *from category");
                              while($row=mysql_fetch_array($category)){ ?>   
                                <div class="container12 category_set_div ">
                                    <a href="product_category.php?maincategory=<?php echo $row['cid']; ?>"> <img src="images/category/<?php echo $row['image']; ?>" class="img-thumbnail category_set container12">   
                                    <div class="overlay <?php if(isset($_GET['maincategory'])){ if(($_GET['maincategory'])==$row['cid']){   echo 'overlay123 ';  } } ?>">
    <div class="text"><?php echo ($row['category_name']); ?></div>
                                    </div></a>
                                </div>     
                         <?php } ?>
                            </div>
			<?php if(mysql_num_rows($mysqluery)>=1){ ?>
                            <div class="mid-popular" id="mid_popular">
